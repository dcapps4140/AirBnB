...
@st.cache
def get_data():
    return pd.read_csv("http://data.insideairbnb.com/united-states/ny/new-york-city/2022-03-05/visualisations/listings.csv")
...
@st.cache
def get_data():
    url = "http://data.insideairbnb.com/united-states/ny/new-york-city/2022-03-05/visualisations/listings.csv"
